...
public class Platform
{
    ...
    private DesiredCapabilities getAndroidDesiredCapabilities()
    {
        ...
        capabilities.setCapability("appium:deviceName", "Google Pixel 5a");
        capabilities.setCapability("appium:platformVersion", "13");
        capabilities.setCapability("appium:automationName", "UiAutomator2");
        capabilities.setCapability("appium:appPackage", "com.networkoptix.nxwitness");
        capabilities.setCapability("appium:appActivity", ".QnActivity");
        capabilities.setCapability("appium:app", "C:\\Users\\zaily\\OneDrive\\Документы\\GitHub\\JavaAppiumAutomation\\apks\\nxwitness-client-22.5.36769-android_arm64-private-prod-firebase.apk");
        return capabilities;
    }
